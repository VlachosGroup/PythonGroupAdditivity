...
Python package, developed in the Vlachos Research Group at the University of Delaware Chemical & Biomolecular Engineering group implements the **F**\ irst-**P**\ rinciples **S**\ emi-**E**\ mpirical (FPSE) **G**\ roup **A**\ dditivity
